...
export function Widget() {
  return (
    <div className="w-[448px] rounded overflow-hidden">
      ...
      {/* Recent Section */}
      <div>
        <div className="bg-zinc-300 dark:bg-zinc-950 px-5 py-2 text-sm text-zinc-500 dark:text-zinc-500">
          Recentes
        </div>
        ...
        <div className="divide-y-2 divide-zinc-300 dark:divide-zinc-950">
          ...
          <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
            ...
            <div className="flex gap-2 self-center">
              <button className="w-8 h-8 rounded flex items-center justify-center gap-1 bg-zinc-400 hover:bg-zinc-500 dark:bg-zinc-800 dark:hover:bg-zinc-700">
                <X className="w-3 h-3 text-zinc-50" />
              </button>
              <button className="w-8 h-8 rounded flex items-center justify-center gap-1 bg-violet-500 hover:bg-violet-600">
